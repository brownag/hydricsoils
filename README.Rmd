...
Note that the main difference between the LRRs is that indicator "A5" is only approved for use in LRR "C" whereas "A9" is approved for use in LRR "D". "A9" is available for testing in "C", and, in contrast, "A5" is neither available, nor being tested, in LRR "D".
